...
//        if ($return !== false) {
//
//            $this->info("You can add this in method <comment>boot</comment> you <comment>AppServiceProvider</comment>:");
//            $this->line("\$this->app->singleton()");
//        }
...
TEXT;
    ...
    {
        return $this->resolveStubPath('/stubs/bfg-repository.stub');
    }
