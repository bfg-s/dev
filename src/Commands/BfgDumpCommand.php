...
/**
 * Class BfgDumpCommand
 * @package Bfg\Dev\Commands
 */
class BfgDumpCommand extends Command
{
    /**
     * Model list for dump
     * @var string
     */
    static $file_name = "BfgDumpSeeder";
     ...
     * @var string
     */
    protected $signature = 'bfg:db_dump';
     ...
     * @var string
     */
    protected $description = 'Make dump of database in the form of seeds laravel';
    ...
    protected function class_exists(string $class)
    {
        ...
        if ($date) {
            ...
            if (!is_dir(database_path("seeds/" . static::$file_name))) {
                mkdir(database_path("seeds/" . static::$file_name), 0777, true);
            }

            file_put_contents(
                database_path("seeds/" . static::$file_name . "/{$name}.dump"),
